...
**Сделано в call/runtime hardening:** полноэкранный запуск мобильного звонка,
исправленный accept/reject, точная идентичность попытки, anti-replay по
ID/времени, encrypted call-control, Matrix request gate с `retry_after_ms`,
fail-closed media E2EE и SQLCipher 4.10
