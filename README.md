...
* 🟡 **Стабильный FPS интерфейса.** Поиск и устранение просадок FPS, рывков
  анимаций и зависаний интерфейса на Web, Windows и Android без упрощения
  дизайна и ухудшения визуальных эффектов;
